...
{
public:
    Disc(Scene& scene, Shader* shaderProgram);
    Disc(Scene& scene, Shader* shaderProgram, std::string filnavn);
    ~Disc() override;
    ...
    void move(float dx, float dy, float dz, float dt, float dr) override;
