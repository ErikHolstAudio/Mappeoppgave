...
{
    mPoints.push_back(Vertex( -2.f, -1.f,  0.f, 1.f, 1.f, 1.f));
    mPoints.push_back(Vertex( -4.f,  3.f,  0.f, 1.f, 1.f, 1.f));
    mPoints.push_back(Vertex(  5.f,  3.f,  0.f, 1.f, 1.f, 1.f));
    mPoints.push_back(Vertex(  3.f, -1.f,  0.f, 1.f, 1.f, 1.f));
    ...
    for (float t = 0.f; t <= max; t += step)
    {
        ...
        mVertices.push_back(Vertex(point.x(), point.y(), point.z(), 0.f, 1.f, 1.f));
