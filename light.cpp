...
Light::Light(Scene& scene, Shader* shaderProgram) : VisualObject(scene, shaderProgram)
{
    mVertices.insert(mVertices.end(),
        {
         gsml::Vertex{gsml::Vector3d(-0.25f, -0.25f,  0.25f),    gsml::Vector3d(0.8f, 0.8f, 0.3f),  gsml::Vector2d(0.0f, 0.0f)},  //Left low
         gsml::Vertex{gsml::Vector3d( 0.25f, -0.25f,  0.25f),    gsml::Vector3d(0.8f, 0.8f, 0.3f),  gsml::Vector2d(1.0f, 0.0f)},  //Right low
         gsml::Vertex{gsml::Vector3d(  0.0f,  0.25f,   0.0f),    gsml::Vector3d(0.8f, 0.8f, 0.3f),  gsml::Vector2d(0.5f, 0.5f)},  //Top
         gsml::Vertex{gsml::Vector3d(  0.0f, -0.25f, -0.25f),    gsml::Vector3d(0.8f, 0.8f, 0.3f),  gsml::Vector2d(0.5f, 0.5f)}   //Back low
        });
